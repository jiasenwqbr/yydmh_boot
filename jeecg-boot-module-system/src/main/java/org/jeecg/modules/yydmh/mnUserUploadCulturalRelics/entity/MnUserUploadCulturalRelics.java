package org.jeecg.modules.yydmh.mnUserUploadCulturalRelics.entity;
 ...
 */
@Data
@TableName("mn_user_upload_cultural_relics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="mn_user_upload_cultural_relics对象", description="用户上传文物")
public class MnUserUploadCulturalRelics implements Serializable {
    ...
    @Autowired
    @Dict(dictTable = "mh_user_register_info" ,dicCode = "id", dicText = "name")
