package org.jeecg.modules.yydmh.mhHaveBuyRelics.entity;
 ...
 */
@Data
@TableName("mh_have_buy_relics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="mh_have_buy_relics对象", description="已买文物")
public class MhHaveBuyRelics implements Serializable {
